...
void main() {
  ...
  test('Happy path for paying with SOL', () async {
    ...
    final url =
        'solana:${recipient.publicKey.toBase58()}'
        '?amount=$amount'
    ...
    final balanceSender =
        await client.rpcClient
            ...
            .value;
    final balanceDecimalSender = Decimal.fromInt(
      balanceSender,
    ...
    final balanceRecipient =
        await client.rpcClient
            ...
            .value;
    final balanceDecimalRecipient = Decimal.fromInt(
      balanceRecipient,
    ).shift(-solDecimalPlaces);
