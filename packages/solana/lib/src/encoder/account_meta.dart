...
class AccountMeta implements Comparable<AccountMeta> {
  const AccountMeta({required this.pubKey, required this.isWriteable, required this.isSigner});
  ...
  factory AccountMeta.writeable({required Ed25519HDPublicKey pubKey, required bool isSigner}) =>
