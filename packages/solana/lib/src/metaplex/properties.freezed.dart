...
Properties _$PropertiesFromJson(
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( Unknown value)?  unknown,TResult? Function( Video value)?  video,TResult? Function( Image value)?  image,TResult? Function( Model3D value)?  vr,TResult? Function( Audio value)?  audio,TResult? Function( Html value)?  html,}){
final _that = this;
switch (_that) {
case Unknown() when unknown != null:
return unknown(_that);case Video() when video != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  unknown,TResult Function( List<File> files)?  video,TResult Function( List<File> files)?  image,TResult Function( List<File> files)?  vr,TResult Function( List<File> files)?  audio,TResult Function( List<File> files)?  html,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Unknown() when unknown != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  unknown,required TResult Function( List<File> files)  video,required TResult Function( List<File> files)  image,required TResult Function( List<File> files)  vr,required TResult Function( List<File> files)  audio,required TResult Function( List<File> files)  html,}) {final _that = this;
switch (_that) {
case Unknown():
return unknown();case Video():
return video(_that.files);case Image():
return image(_that.files);case Model3D():
return vr(_that.files);case Audio():
return audio(_that.files);case Html():
return html(_that.files);}
}
...
class Video implements Properties {
  const Video({required final  List<File> files, final  String? $type}): _files = files,$type = $type ?? 'video';
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Video&&const DeepCollectionEquality().equals(other._files, _files));
}
...
class Image implements Properties {
  const Image({required final  List<File> files, final  String? $type}): _files = files,$type = $type ?? 'image';
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Image&&const DeepCollectionEquality().equals(other._files, _files));
}
...
class Model3D implements Properties {
  const Model3D({required final  List<File> files, final  String? $type}): _files = files,$type = $type ?? 'vr';
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Model3D&&const DeepCollectionEquality().equals(other._files, _files));
}
...
/// @nodoc
class _$Model3DCopyWithImpl<$Res>
...
class Audio implements Properties {
  const Audio({required final  List<File> files, final  String? $type}): _files = files,$type = $type ?? 'audio';
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Audio&&const DeepCollectionEquality().equals(other._files, _files));
}
...
class Html implements Properties {
  const Html({required final  List<File> files, final  String? $type}): _files = files,$type = $type ?? 'html';
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Html&&const DeepCollectionEquality().equals(other._files, _files));
}
