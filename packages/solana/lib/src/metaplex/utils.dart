...
Future<Ed25519HDPublicKey> findMetaplexMetadataProgramAddress(Ed25519HDPublicKey mint) =>
...
Future<Ed25519HDPublicKey> findMetaplexEditionProgramAddress(Ed25519HDPublicKey mint) =>
    Ed25519HDPublicKey.findProgramAddress(
      seeds: [
        'metadata'.codeUnits,
        ByteArray.fromBase58(metaplexMetadataProgramId),
