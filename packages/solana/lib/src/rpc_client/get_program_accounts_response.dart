...
class GetProgramAccountsResponse extends JsonRpcResponse<List<AccountWithPubkey>> {
  GetProgramAccountsResponse(List<AccountWithPubkey> result) : super(result: result);
