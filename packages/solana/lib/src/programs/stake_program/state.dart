...
abstract class StakeAuthorize {
  const factory StakeAuthorize.staker(Ed25519HDPublicKey pubKey) = StakerAuthority;

  const factory StakeAuthorize.withdrawer(Ed25519HDPublicKey pubKey) = WithdrawerAuthority;
...
class StakerAuthority implements StakeAuthorize {
  ...
  @override
  ByteArray serialize() => ByteArray.merge([pubKey.toByteArray(), ByteArray.u32(type)]);
