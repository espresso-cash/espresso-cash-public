...
abstract final class Token2022Program {
  ...
  static final initializeMintCloseAuthorityInstructionIndex = ByteArray(const [25]);
  static final transferFeeExtensionInstructionIndex = ByteArray(const [26]);
  static final confidentialTransferExtensionInstructionIndex = ByteArray(const [27]);
  static final defaultAccountStateExtensionInstructionIndex = ByteArray(const [28]);
  ...
  static final initializeNonTransferableMintInstructionIndex = ByteArray(const [32]);
  static final interestBearingMintExtensionInstructionIndex = ByteArray(const [33]);
  static final cpiGuardExtensionInstructionIndex = ByteArray(const [34]);
  static final initializePermanentDelegateInstructionIndex = ByteArray(const [35]);
  static final transferHookExtensionInstructionIndex = ByteArray(const [36]);
  static final confidentialTransferFeeExtensionInstructionIndex = ByteArray(const [37]);
  ...
  static final groupMemberPointerExtensionInstructionIndex = ByteArray(const [41]);
}
