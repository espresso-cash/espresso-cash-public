...
abstract class SystemProgram {
  ...
  static final createAccountWithSeedInstructionIndex = ByteArray(const [
    3,
    0,
    0,
    0,
  ]);
  static final advanceNonceAccountInstructionIndex = ByteArray(const [
    4,
    0,
    0,
    0,
  ]);
  static final withdrawNonceAccountInstructionIndex = ByteArray(const [
    5,
    0,
    0,
    0,
  ]);
  static final initializeNonceAccountInstructionIndex = ByteArray(const [
    6,
    0,
    0,
    0,
  ]);
  static final authorizeNonceAccountInstructionIndex = ByteArray(const [
    7,
    0,
    0,
    0,
  ...
  static final transferWithSeedInstructionIndex = ByteArray(const [
    11,
    0,
    0,
    0,
