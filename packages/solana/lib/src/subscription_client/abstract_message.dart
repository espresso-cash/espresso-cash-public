...
abstract class SubscriptionMessage {
  ...
  // request.
  factory SubscriptionMessage.fromJson(Map<String, dynamic> data) {
    if (data.containsKey('method')) {
      ...
      if (data['result'] is int) {
        return SubscribedMessage.fromJson(data);
      } else if (data['result'] is bool) {
        return UnsubscribedMessage.fromJson(data);
      } else {
