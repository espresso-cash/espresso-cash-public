...
mixin _$TransactionRequestInfo {
  ...
  $TransactionRequestInfoCopyWith<TransactionRequestInfo> get copyWith =>
      _$TransactionRequestInfoCopyWithImpl<TransactionRequestInfo>(
        this as TransactionRequestInfo,
        _$identity,
      );
...
abstract mixin class $TransactionRequestInfoCopyWith<$Res> {
  factory $TransactionRequestInfoCopyWith(
    ...
    $Res Function(TransactionRequestInfo) _then,
  ) = _$TransactionRequestInfoCopyWithImpl;
  @useResult
  $Res call({String label, String icon});
}

/// @nodoc
class _$TransactionRequestInfoCopyWithImpl<$Res> implements $TransactionRequestInfoCopyWith<$Res> {
...
class _TransactionRequestInfo implements TransactionRequestInfo {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TransactionRequestInfoCopyWith<_TransactionRequestInfo> get copyWith =>
      __$TransactionRequestInfoCopyWithImpl<_TransactionRequestInfo>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _TransactionRequestInfo &&
            (identical(other.label, label) || other.label == label) &&
            (identical(other.icon, icon) || other.icon == icon));
  }
...
/// @nodoc
abstract mixin class _$TransactionRequestInfoCopyWith<$Res>
    implements $TransactionRequestInfoCopyWith<$Res> {
  factory _$TransactionRequestInfoCopyWith(
    _TransactionRequestInfo value,
    $Res Function(_TransactionRequestInfo) _then,
  ) = __$TransactionRequestInfoCopyWithImpl;
  @override
  @useResult
  $Res call({String label, String icon});
}
...
mixin _$TransactionRequestResponse {
  ...
  $TransactionRequestResponseCopyWith<TransactionRequestResponse> get copyWith =>
      _$TransactionRequestResponseCopyWithImpl<TransactionRequestResponse>(
        this as TransactionRequestResponse,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is TransactionRequestResponse &&
...
abstract mixin class $TransactionRequestResponseCopyWith<$Res> {
  factory $TransactionRequestResponseCopyWith(
    ...
    $Res Function(TransactionRequestResponse) _then,
  ) = _$TransactionRequestResponseCopyWithImpl;
  @useResult
...
class _TransactionRequestResponse implements TransactionRequestResponse {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TransactionRequestResponseCopyWith<_TransactionRequestResponse> get copyWith =>
      __$TransactionRequestResponseCopyWithImpl<_TransactionRequestResponse>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _TransactionRequestResponse &&
            (identical(other.transaction, transaction) || other.transaction == transaction) &&
            (identical(other.message, message) || other.message == message) &&
            (identical(other.redirect, redirect) || other.redirect == redirect));
  }
...
/// @nodoc
abstract mixin class _$TransactionRequestResponseCopyWith<$Res>
    implements $TransactionRequestResponseCopyWith<$Res> {
  factory _$TransactionRequestResponseCopyWith(
    _TransactionRequestResponse value,
    $Res Function(_TransactionRequestResponse) _then,
  ) = __$TransactionRequestResponseCopyWithImpl;
  @override
  @useResult
  $Res call({String transaction, String? message, String? redirect});
}
