...
MintAccountDataInfo _$MintAccountDataInfoFromJson(Map<String, dynamic> json) => MintAccountDataInfo(
...
Map<String, dynamic> _$MintAccountDataInfoToJson(MintAccountDataInfo instance) => <String, dynamic>{
