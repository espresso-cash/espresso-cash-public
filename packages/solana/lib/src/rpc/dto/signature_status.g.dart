...
SignatureStatus _$SignatureStatusFromJson(Map<String, dynamic> json) => SignatureStatus(
  slot: (json['slot'] as num).toInt(),
  confirmationStatus: $enumDecode(_$CommitmentEnumMap, json['confirmationStatus']),
  confirmations: (json['confirmations'] as num?)?.toInt(),
  err: json['err'] as Map<String, dynamic>?,
);

Map<String, dynamic> _$SignatureStatusToJson(SignatureStatus instance) => <String, dynamic>{
  'slot': instance.slot,
