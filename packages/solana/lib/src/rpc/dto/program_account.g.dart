...
ProgramAccount _$ProgramAccountFromJson(Map<String, dynamic> json) => ProgramAccount(
  account: Account.fromJson(json['account'] as Map<String, dynamic>),
  pubkey: json['pubkey'] as String,
);

Map<String, dynamic> _$ProgramAccountToJson(ProgramAccount instance) => <String, dynamic>{
