...
TransactionStatusResult _$TransactionStatusResultFromJson(Map<String, dynamic> json) =>
    TransactionStatusResult(
      context: Context.fromJson(json['context'] as Map<String, dynamic>),
      value: TransactionStatus.fromJson(json['value'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$TransactionStatusResultToJson(TransactionStatusResult instance) =>
