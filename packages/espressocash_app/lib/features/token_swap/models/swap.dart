...
class SwapStatus with _$SwapStatus {
  ...
  const factory SwapStatus.txSent(SignedTx tx, {required BigInt slot}) = SwapStatusTxSent;
  ...
  const factory SwapStatus.txFailure({required TxFailureReason reason}) = SwapStatusTxFailure;
}
