...
class NetworkPickerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => CpTheme.dark(
    child: Scaffold(
      ...
      appBar: CpAppBar(title: Text(context.l10n.walletNetworks.toUpperCase())),
      body: _Content(initial: initial, onSubmitted: onSubmitted),
    ),
  );
}

class _Content extends StatefulWidget {
  const _Content({this.initial, required this.onSubmitted});
