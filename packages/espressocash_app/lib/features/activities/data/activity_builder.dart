...
extension PaymentRequestRowToActivityExt on PaymentRequestRow {
  Activity toActivity() =>
      Activity.outgoingPaymentRequest(id: id, created: created);
}
...
extension OutgoingDlnPaymentRowToActivityExt on OutgoingDlnPaymentRow {
  Activity toActivity() =>
      Activity.outgoingDlnPayment(id: id, created: created, data: toModel());
}
...
extension TransactionRequestPaymentExt on TransactionRequestPayment {
  Activity toActivity() =>
      Activity.transactionRequest(id: id, created: created, data: this);
}
