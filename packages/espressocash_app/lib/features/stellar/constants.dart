...
const _isStellarProd = bool.fromEnvironment('STELLAR_PROD', defaultValue: false);
...
const _devSigningKey = 'GCSESAP5ILVM6CWIEGK2SDOCQU7PHVFYYT7JNKRDAQNVQWKD5YEE5ZJ4';
const _prodSigningKey = 'GD5NUMEX7LYHXGXCAD4PGW7JDMOUY2DKRGY5XZHJS5IONVHDKCJYGVCL';
const moneygramSigningKey = _isStellarProd ? _prodSigningKey : _devSigningKey;

const _devAssetIssuer = 'GBBD47IF6LWK7P7MDEVSCWR7DPUWV3NY3DTQEVFL4NAT4AQH3ZLLFLA5';
const _prodAssetIssuer = 'GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN';
const moneygramAssetIssuer = _isStellarProd ? _prodAssetIssuer : _devAssetIssuer;
