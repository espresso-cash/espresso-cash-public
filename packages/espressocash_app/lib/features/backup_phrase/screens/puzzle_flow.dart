...
extension PuzzleFlow on BuildContext {
  void launchPuzzleFlow() {
    ...
    MaterialPageRoute<void> successRoute() =>
        MaterialPageRoute(builder: (context) => PuzzleSuccessScreen(onDone: () => context.openFirstScreen()));
    ...
    navigator.push<void>(
      MaterialPageRoute(
        builder: (context) => PuzzleViewPhraseScreen(onConfirmed: (phrase) => navigator.push(inputPhraseRoute(phrase))),
      ),
    );
  }
}
