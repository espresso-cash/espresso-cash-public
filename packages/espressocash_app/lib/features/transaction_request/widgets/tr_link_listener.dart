...
class _TRLinkListenerState extends State<TRLinkListener> with DynamicLinkHandler {
  @override
  bool handleDynamicLink(Uri uri) {
    final transactionRequest = SolanaTransactionRequest.tryParse(uri.toString());
