...
class RampPartnerSelectScreen extends StatefulWidget {
  const RampPartnerSelectScreen({super.key, required this.type, required this.onPartnerSelected});
  ...
  @override
  State<RampPartnerSelectScreen> createState() => _RampPartnerSelectScreenState();
}
      ...
      body: OnboardingScreen(
        children: [
          if (_partners.isEmpty) ...[
            ...
            switch (widget.type) {
              RampType.onRamp => Assets.images.cashInGraphic.image(height: 100.h),
              RampType.offRamp => Assets.images.cashOutGraphic.image(height: 100.h),
            },
          ...
          Padding(
            ...
            child: EcMarkdownText(
              text: switch (widget.type) {
                RampType.onRamp => context.l10n.selectPartnerOnRampTitle.toUpperCase(),
                RampType.offRamp => context.l10n.selectPartnerOffRampTitle.toUpperCase(),
              },
            ),
          ),
          SizedBox(height: 20.h),
