...
sealed class OrderDataDto with _$OrderDataDto {
...
@Freezed(toJson: false)
sealed class QuoteDto with _$QuoteDto {
...
@Freezed(toJson: false)
sealed class AmountDto with _$AmountDto {
...
@Freezed(toJson: false)
sealed class OrderStatusResponseDto with _$OrderStatusResponseDto {
