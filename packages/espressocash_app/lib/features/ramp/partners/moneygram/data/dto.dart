...
@freezed
sealed class MgWithdrawRequestDto with _$MgWithdrawRequestDto {
...
@freezed
sealed class MgWithdrawResponseDto with _$MgWithdrawResponseDto {
  @JsonSerializable(fieldRename: FieldRename.snake)
...
@freezed
sealed class MgFetchTransactionResponseDto with _$MgFetchTransactionResponseDto {
  @JsonSerializable(fieldRename: FieldRename.snake)
