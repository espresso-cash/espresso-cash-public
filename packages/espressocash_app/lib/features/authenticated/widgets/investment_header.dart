  ...
  Widget build(BuildContext context) {
    ...
    return DecoratedBox(
      ...
      child: ValueStreamBuilder<bool>(
        create: () => sl<WatchUserCashBalance>().call().map((it) => it.isZero),
                ...
                children: [
                  if (!isZeroAmount) ...[
                    SizedBox(
                      ...
                      child:
                          PayOrRequestButton(voidCallback: onSendMoneyPressed),
                    ),
                  ],
                  SizedBox(
                    width: mediaQueryData.size.width * 0.3,
                    child: const AddCashButton(size: CpButtonSize.wide),
                  ),
                  if (!isZeroAmount) ...[
                    SizedBox(
                      width: mediaQueryData.size.width * 0.3,
                      child: const CashOutButton(size: CpButtonSize.wide),
                    ),
                  ],
                ],
              ),
