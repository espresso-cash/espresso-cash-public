...
import 'package:cryptoplease/presentation/screens/authenticated/swap_tokens/swap_token_screen.dart';
...
const authenticatedFlowRoutes = AutoRoute<void>(
  ...
  children: [
    AutoRoute<void>(path: '', page: SwapTokenScreen),
    ...
    // AutoRoute<void>(page: SwapTokenScreen),
  ],
);
