...
import 'package:cryptoplease/presentation/screens/authenticated/send_flow/fungible_token/enter_address/enter_address_screen.dart';
...
import 'package:cryptoplease/presentation/screens/authenticated/send_flow/non_fungible_token/enter_address/enter_address_screen.dart';
...
const createPaymentFlowRoutes = [
  AutoRoute<void>(
    ...
    children: [
      ...
      AutoRoute<void>(page: EnterFungibleTokenAddressScreen),
  ...
  AutoRoute<void>(
    ...
    children: [
      AutoRoute<void>(path: '', page: PickRecipientTypeScreen),
      AutoRoute<QrScannerRequest>(page: QrScannerScreen),
      AutoRoute<void>(page: EnterNonFungibleTokenAddressScreen),
