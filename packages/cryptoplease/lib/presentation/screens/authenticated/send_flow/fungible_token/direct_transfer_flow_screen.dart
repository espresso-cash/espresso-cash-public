...
class DirectTransferFlowScreen extends StatefulWidget {
  const DirectTransferFlowScreen({
    Key? key,
  ...
  @override
  State<DirectTransferFlowScreen> createState() =>
      _DirectTransferFlowScreenState();
}

class _DirectTransferFlowScreenState extends State<DirectTransferFlowScreen> {
  @override
