...
class _EspressoCashClient implements EspressoCashClient {
  ...
  Future<ScalexBrijFeeResponseDto> fetchScalexBrijFees(
      ScalexBrijFeeRequestDto request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ScalexBrijFeeResponseDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ScalexBrijFeeResponseDto.fromJson(_result.data!);
    return value;
  }
  ...
  Future<FiatRateResponseDto> fetchFiatRate(FiatRateRequestDto request) async {
    ...
    _data.addAll(request.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<FiatRateResponseDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = FiatRateResponseDto.fromJson(_result.data!);
    return value;
  }
  ...
  Future<void> addAmbassadorReferral(
      AmbassadorReferralRequestDto request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<AmbassadorStatsResponseDto> getAmbassadorStats() async {
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<AmbassadorStatsResponseDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = AmbassadorStatsResponseDto.fromJson(_result.data!);
    return value;
  }
  ...
  Future<AmbassadorVerificationResponseDto> verifyAmbassador() async {
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<AmbassadorVerificationResponseDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = AmbassadorVerificationResponseDto.fromJson(_result.data!);
    return value;
  }
