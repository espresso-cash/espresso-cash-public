...
) => _$AmbassadorReferralRequestDtoImpl(ambassadorAddress: json['ambassadorAddress'] as String);
...
_$AmbassadorStatsResponseDtoImpl _$$AmbassadorStatsResponseDtoImplFromJson(
  Map<String, dynamic> json,
) => _$AmbassadorStatsResponseDtoImpl(referralCount: (json['referralCount'] as num).toInt());
...
_$AmbassadorVerificationResponseDtoImpl _$$AmbassadorVerificationResponseDtoImplFromJson(
  Map<String, dynamic> json,
...
) => <String, dynamic>{'isAmbassador': instance.isAmbassador, 'isReferral': instance.isReferral};
