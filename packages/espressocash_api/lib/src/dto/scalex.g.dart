...
_$GenerateScalexLinkResponseDtoImpl _$$GenerateScalexLinkResponseDtoImplFromJson(
  Map<String, dynamic> json,
) => _$GenerateScalexLinkResponseDtoImpl(signedUrl: json['signedUrl'] as String);

Map<String, dynamic> _$$GenerateScalexLinkResponseDtoImplToJson(
  _$GenerateScalexLinkResponseDtoImpl instance,
) => <String, dynamic>{'signedUrl': instance.signedUrl};
...
_$ScalexWithdrawRequestDtoImpl _$$ScalexWithdrawRequestDtoImplFromJson(Map<String, dynamic> json) =>
...
) => <String, dynamic>{'orderId': instance.orderId, 'cluster': _$ClusterEnumMap[instance.cluster]!};

const _$ClusterEnumMap = {Cluster.mainnet: 'mainnet', Cluster.devnet: 'devnet'};
...
_$OnRampScalexDetailsImpl _$$OnRampScalexDetailsImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$OnRampScalexDetailsImplToJson(_$OnRampScalexDetailsImpl instance) =>
    <String, dynamic>{
      'currency': instance.currency,
...
_$ScalexRateFeeResponseDtoImpl _$$ScalexRateFeeResponseDtoImplFromJson(Map<String, dynamic> json) =>
...
_$ScalexBrijFeeRequestDtoImpl _$$ScalexBrijFeeRequestDtoImplFromJson(Map<String, dynamic> json) =>
    _$ScalexBrijFeeRequestDtoImpl(
      amount: json['amount'] as String,
      type: $enumDecode(_$RampTypeDtoEnumMap, json['type']),
    );

Map<String, dynamic> _$$ScalexBrijFeeRequestDtoImplToJson(_$ScalexBrijFeeRequestDtoImpl instance) =>
...
_$ScalexFeesImpl _$$ScalexFeesImplFromJson(Map<String, dynamic> json) => _$ScalexFeesImpl(
...
Map<String, dynamic> _$$ScalexFeesImplToJson(_$ScalexFeesImpl instance) => <String, dynamic>{
...
_$ScalexBrijFeeResponseDtoImpl _$$ScalexBrijFeeResponseDtoImplFromJson(Map<String, dynamic> json) =>
    _$ScalexBrijFeeResponseDtoImpl(
      ...
      scalexFees: ScalexFees.fromJson(json['scalexFees'] as Map<String, dynamic>),
    );
