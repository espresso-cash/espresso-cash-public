...
_$GasFeeRequestDtoImpl _$$GasFeeRequestDtoImplFromJson(Map<String, dynamic> json) =>
    _$GasFeeRequestDtoImpl(network: json['network'] as String);

Map<String, dynamic> _$$GasFeeRequestDtoImplToJson(_$GasFeeRequestDtoImpl instance) =>
    <String, dynamic>{'network': instance.network};

_$GasFeeResponseDtoImpl _$$GasFeeResponseDtoImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$GasFeeResponseDtoImplToJson(_$GasFeeResponseDtoImpl instance) =>
    <String, dynamic>{
      'low': instance.low,
...
_$GasFeeEstimateImpl _$$GasFeeEstimateImplFromJson(Map<String, dynamic> json) =>
    _$GasFeeEstimateImpl(
      suggestedMaxPriorityFeePerGas: json['suggestedMaxPriorityFeePerGas'] as String,
...
Map<String, dynamic> _$$GasFeeEstimateImplToJson(_$GasFeeEstimateImpl instance) =>
    <String, dynamic>{
