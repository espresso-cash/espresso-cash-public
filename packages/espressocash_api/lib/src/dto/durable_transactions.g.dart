...
_$GetFreeNonceResponseDtoImpl _$$GetFreeNonceResponseDtoImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$GetFreeNonceResponseDtoImplToJson(_$GetFreeNonceResponseDtoImpl instance) =>
    <String, dynamic>{
