...
_$GetFeesResponseDtoImpl _$$GetFeesResponseDtoImplFromJson(Map<String, dynamic> json) =>
    _$GetFeesResponseDtoImpl(
      directPayment: DirectPaymentFeeDto.fromJson(json['directPayment'] as Map<String, dynamic>),
      ...
      withdrawFeePercentage:
          json['withdrawFeePercentage'] == null
              ? const WithdrawFeeDto()
              : WithdrawFeeDto.fromJson(json['withdrawFeePercentage'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$GetFeesResponseDtoImplToJson(_$GetFeesResponseDtoImpl instance) =>
    <String, dynamic>{
...
_$DirectPaymentFeeDtoImpl _$$DirectPaymentFeeDtoImplFromJson(Map<String, dynamic> json) =>
    _$DirectPaymentFeeDtoImpl(
      ataExists: (json['ataExists'] as num).toInt(),
      ataDoesNotExist: (json['ataDoesNotExist'] as num).toInt(),
    );

Map<String, dynamic> _$$DirectPaymentFeeDtoImplToJson(_$DirectPaymentFeeDtoImpl instance) =>
    <String, dynamic>{'ataExists': instance.ataExists, 'ataDoesNotExist': instance.ataDoesNotExist};
...
Map<String, dynamic> _$$WithdrawFeeDtoImplToJson(_$WithdrawFeeDtoImpl instance) =>
    <String, dynamic>{
