...
_$CreatePaymentRequestDtoImpl _$$CreatePaymentRequestDtoImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$CreatePaymentRequestDtoImplToJson(_$CreatePaymentRequestDtoImpl instance) =>
    <String, dynamic>{
...
_$CreatePaymentResponseDtoImpl _$$CreatePaymentResponseDtoImplFromJson(Map<String, dynamic> json) =>
...
) => <String, dynamic>{'transaction': instance.transaction, 'slot': instance.slot.toString()};

_$ReceivePaymentRequestDtoImpl _$$ReceivePaymentRequestDtoImplFromJson(Map<String, dynamic> json) =>
...
_$CreateDirectPaymentRequestDtoImpl _$$CreateDirectPaymentRequestDtoImplFromJson(
  Map<String, dynamic> json,
...
_$CreateDirectPaymentResponseDtoImpl _$$CreateDirectPaymentResponseDtoImplFromJson(
  Map<String, dynamic> json,
...
_$CancelPaymentRequestDtoImpl _$$CancelPaymentRequestDtoImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$CancelPaymentRequestDtoImplToJson(_$CancelPaymentRequestDtoImpl instance) =>
    <String, dynamic>{
      'senderAccount': instance.senderAccount,
      'escrowAccount': instance.escrowAccount,
      'cluster': _$ClusterEnumMap[instance.cluster]!,
...
_$CancelPaymentResponseDtoImpl _$$CancelPaymentResponseDtoImplFromJson(Map<String, dynamic> json) =>
