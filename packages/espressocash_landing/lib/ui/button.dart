...
class CpButton extends StatelessWidget {
  ...
  Color get _backgroundColor {
    switch (variant) {
      case CpButtonVariant.dark:
        return EcLandingColors.yellowColor;
      case CpButtonVariant.inverted:
        return EcLandingColors.darkBackground;
      case CpButtonVariant.light:
        return EcLandingColors.lightButtonBackgroundColor;
      case CpButtonVariant.secondary:
        return EcLandingColors.lightGreyBackground;
  ...
  Color get _foregroundColor {
    switch (variant) {
      ...
      case CpButtonVariant.dark:
      case CpButtonVariant.light:
        return EcLandingColors.primaryTextColor;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final button = TextButton(
      ...
      style: ButtonStyle(
        ...
        overlayColor:
            MaterialStateProperty.all(EcLandingColors.translucentYellowColor),
