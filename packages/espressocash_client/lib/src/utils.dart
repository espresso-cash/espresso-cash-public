...
GasFeeEstimate mapProtoToGasFeeEstimate(dln_proto.GasFeeEstimate estimate) =>
    GasFeeEstimate(
...
DlnOrderStatus mapDlnOrderStatus(dln_proto.DlnOrderStatus status) =>
    switch (status) {
      dln_proto.DlnOrderStatus.DLN_ORDER_STATUS_CREATED =>
        DlnOrderStatus.created,
      dln_proto.DlnOrderStatus.DLN_ORDER_STATUS_FULFILLED =>
        DlnOrderStatus.fulfilled,
      dln_proto.DlnOrderStatus.DLN_ORDER_STATUS_SENT_UNLOCK =>
        DlnOrderStatus.sentUnlock,
      dln_proto.DlnOrderStatus.DLN_ORDER_STATUS_ORDER_CANCELLED =>
        DlnOrderStatus.orderCancelled,
      dln_proto.DlnOrderStatus.DLN_ORDER_STATUS_SENT_ORDER_CANCEL =>
        DlnOrderStatus.sentOrderCancel,
      dln_proto.DlnOrderStatus.DLN_ORDER_STATUS_CLAIMED_UNLOCK =>
        DlnOrderStatus.claimedUnlock,
      dln_proto.DlnOrderStatus.DLN_ORDER_STATUS_CLAIMED_ORDER_CANCEL =>
        DlnOrderStatus.claimedOrderCancel,
      dln_proto.DlnOrderStatus.DLN_ORDER_STATUS_NONE ||
      _ =>
        DlnOrderStatus.none,
    };
