...
class PaymentServiceClient extends $grpc.Client {
  static final _$createDirectPayment =
      $grpc.ClientMethod<$1.CreateDirectPaymentRequest, $1.CreateDirectPaymentResponse>(
  ...
  static final _$getDirectPaymentQuote =
      $grpc.ClientMethod<$1.GetDirectPaymentQuoteRequest, $1.GetDirectPaymentQuoteResponse>(
  ...
  static final _$createEscrowPayment =
      $grpc.ClientMethod<$1.CreateEscrowPaymentRequest, $1.CreateEscrowPaymentResponse>(
  ...
  static final _$receiveEscrowPayment =
      $grpc.ClientMethod<$1.ReceiveEscrowPaymentRequest, $1.ReceiveEscrowPaymentResponse>(
  ...
  static final _$cancelEscrowPayment =
      $grpc.ClientMethod<$1.CancelEscrowPaymentRequest, $1.CancelEscrowPaymentResponse>(
  ...
  static final _$getOutgoingEscrowPaymentQuote = $grpc.ClientMethod<
          $1.GetOutgoingEscrowPaymentQuoteRequest, $1.GetOutgoingEscrowPaymentQuoteResponse>(
  ...
  static final _$getIncomingEscrowPaymentQuote = $grpc.ClientMethod<
          $1.GetIncomingEscrowPaymentQuoteRequest, $1.GetIncomingEscrowPaymentQuoteResponse>(
  ...
  $grpc.ResponseFuture<$1.GetOutgoingEscrowPaymentQuoteResponse> getOutgoingEscrowPaymentQuote(
  ...
  $grpc.ResponseFuture<$1.GetIncomingEscrowPaymentQuoteResponse> getIncomingEscrowPaymentQuote(
...
abstract class PaymentServiceBase extends $grpc.Service {
  ...
  PaymentServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$1.GetDirectPaymentQuoteRequest, $1.GetDirectPaymentQuoteResponse>(
  ...
  $async.Future<$1.CreateDirectPaymentResponse> createDirectPayment_Pre(
      $grpc.ServiceCall call, $async.Future<$1.CreateDirectPaymentRequest> request) async {
    return createDirectPayment(call, await request);
  }

  $async.Future<$1.GetDirectPaymentQuoteResponse> getDirectPaymentQuote_Pre(
      $grpc.ServiceCall call, $async.Future<$1.GetDirectPaymentQuoteRequest> request) async {
    return getDirectPaymentQuote(call, await request);
  }

  $async.Future<$1.CreateEscrowPaymentResponse> createEscrowPayment_Pre(
      $grpc.ServiceCall call, $async.Future<$1.CreateEscrowPaymentRequest> request) async {
    return createEscrowPayment(call, await request);
  }

  $async.Future<$1.ReceiveEscrowPaymentResponse> receiveEscrowPayment_Pre(
      $grpc.ServiceCall call, $async.Future<$1.ReceiveEscrowPaymentRequest> request) async {
    return receiveEscrowPayment(call, await request);
  }

  $async.Future<$1.CancelEscrowPaymentResponse> cancelEscrowPayment_Pre(
      $grpc.ServiceCall call, $async.Future<$1.CancelEscrowPaymentRequest> request) async {
    return cancelEscrowPayment(call, await request);
  }

  $async.Future<$1.GetOutgoingEscrowPaymentQuoteResponse> getOutgoingEscrowPaymentQuote_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.GetOutgoingEscrowPaymentQuoteRequest> request) async {
    return getOutgoingEscrowPaymentQuote(call, await request);
  }

  $async.Future<$1.GetIncomingEscrowPaymentQuoteResponse> getIncomingEscrowPaymentQuote_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.GetIncomingEscrowPaymentQuoteRequest> request) async {
  ...
  $async.Future<$1.GetOutgoingEscrowPaymentQuoteResponse> getOutgoingEscrowPaymentQuote(
      $grpc.ServiceCall call, $1.GetOutgoingEscrowPaymentQuoteRequest request);
  $async.Future<$1.GetIncomingEscrowPaymentQuoteResponse> getIncomingEscrowPaymentQuote(
      $grpc.ServiceCall call, $1.GetIncomingEscrowPaymentQuoteRequest request);
}
