...
class UserServiceClient extends $grpc.Client {
  ...
  static final _$getWalletProofMessage = $grpc.ClientMethod<$5.GetWalletProofMessageRequest, $5.GetWalletProofMessageResponse>(
  ...
  static final _$updateCountry = $grpc.ClientMethod<$5.UpdateCountryRequest, $5.UpdateCountryResponse>(
  ...
  $grpc.ResponseFuture<$5.LoginResponse> login($5.LoginRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$login, request, options: options);
  }

  $grpc.ResponseFuture<$5.GetWalletProofMessageResponse> getWalletProofMessage($5.GetWalletProofMessageRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getWalletProofMessage, request, options: options);
  }

  $grpc.ResponseFuture<$5.UpdateCountryResponse> updateCountry($5.UpdateCountryRequest request, {$grpc.CallOptions? options}) {
...
abstract class UserServiceBase extends $grpc.Service {
  ...
  UserServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$5.GetWalletProofMessageRequest, $5.GetWalletProofMessageResponse>(
  ...
  $async.Future<$5.LoginResponse> login_Pre($grpc.ServiceCall call, $async.Future<$5.LoginRequest> request) async {
    return login(call, await request);
  }

  $async.Future<$5.GetWalletProofMessageResponse> getWalletProofMessage_Pre($grpc.ServiceCall call, $async.Future<$5.GetWalletProofMessageRequest> request) async {
    return getWalletProofMessage(call, await request);
  }

  $async.Future<$5.UpdateCountryResponse> updateCountry_Pre($grpc.ServiceCall call, $async.Future<$5.UpdateCountryRequest> request) async {
    return updateCountry(call, await request);
  }

  $async.Future<$5.LoginResponse> login($grpc.ServiceCall call, $5.LoginRequest request);
  $async.Future<$5.GetWalletProofMessageResponse> getWalletProofMessage($grpc.ServiceCall call, $5.GetWalletProofMessageRequest request);
  $async.Future<$5.UpdateCountryResponse> updateCountry($grpc.ServiceCall call, $5.UpdateCountryRequest request);
}
