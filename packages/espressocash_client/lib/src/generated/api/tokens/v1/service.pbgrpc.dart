...
class TokensServiceClient extends $grpc.Client {
  ...
  static final _$getTokensMeta =
      $grpc.ClientMethod<$6.GetTokensMetaRequest, $6.GetTokensMetaResponse>(
          ...
          ($core.List<$core.int> value) =>
              $6.GetTokensMetaResponse.fromBuffer(value));
  static final _$getTokensFile =
      $grpc.ClientMethod<$6.GetTokensFileRequest, $6.GetTokensFileResponse>(
          ...
          ($core.List<$core.int> value) =>
              $6.GetTokensFileResponse.fromBuffer(value));

  TokensServiceClient(super.channel, {super.options, super.interceptors});

  $grpc.ResponseFuture<$6.GetTokensMetaResponse> getTokensMeta(
      $6.GetTokensMetaRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getTokensMeta, request, options: options);
  }

  $grpc.ResponseFuture<$6.GetTokensFileResponse> getTokensFile(
      $6.GetTokensFileRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class TokensServiceBase extends $grpc.Service {
  ...
  TokensServiceBase() {
    $addMethod(
        $grpc.ServiceMethod<$6.GetTokensMetaRequest, $6.GetTokensMetaResponse>(
            'GetTokensMeta',
            getTokensMeta_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $6.GetTokensMetaRequest.fromBuffer(value),
            ($6.GetTokensMetaResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$6.GetTokensFileRequest, $6.GetTokensFileResponse>(
            'GetTokensFile',
            getTokensFile_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $6.GetTokensFileRequest.fromBuffer(value),
            ($6.GetTokensFileResponse value) => value.writeToBuffer()));
  }

  $async.Future<$6.GetTokensMetaResponse> getTokensMeta_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$6.GetTokensMetaRequest> $request) async {
    return getTokensMeta($call, await $request);
  }

  $async.Future<$6.GetTokensFileResponse> getTokensFile_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$6.GetTokensFileRequest> $request) async {
