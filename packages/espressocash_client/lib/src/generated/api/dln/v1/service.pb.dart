...
class GetOrderStatusResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set status(DlnOrderStatus v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class GetIncomingQuoteResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set tx(QuoteTx v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set usdcInfo(QuoteUsdcInfo v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class GetGasFeesResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set low(GasFeeEstimate v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set medium(GasFeeEstimate v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set high(GasFeeEstimate v) { $_setField(3, v); }
  @$pb.TagNumber(3)
