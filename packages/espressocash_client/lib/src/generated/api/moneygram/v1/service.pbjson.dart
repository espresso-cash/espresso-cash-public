...
final $typed_data.Uint8List moneygramChallengeSignRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List moneygramChallengeSignResponseDescriptor = $convert.base64Decode(
...
const MoneygramFeeRequest$json = {
  ...
  '2': [
    ...
    {'1': 'type', '3': 2, '4': 1, '5': 14, '6': '.espressocash.api.moneygram.v1.RampType', '10': 'type'},
  ],
};
...
final $typed_data.Uint8List fundXlmResponseDescriptor = $convert.base64Decode(
    'Cg9GdW5kWGxtUmVzcG9uc2U=');
