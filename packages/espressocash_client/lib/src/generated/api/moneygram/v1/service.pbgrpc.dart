...
class MoneygramServiceClient extends $grpc.Client {
  ...
  static final _$signChallenge = $grpc.ClientMethod<$1.MoneygramChallengeSignRequest, $1.MoneygramChallengeSignResponse>(
  ...
  static final _$swapToSolana = $grpc.ClientMethod<$1.SwapToSolanaRequest, $1.MoneygramSwapResponse>(
  ...
  static final _$swapToStellar = $grpc.ClientMethod<$1.SwapToStellarRequest, $1.MoneygramSwapResponse>(
  ...
  $grpc.ResponseFuture<$1.MoneygramChallengeSignResponse> signChallenge($1.MoneygramChallengeSignRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$signChallenge, request, options: options);
  }

  $grpc.ResponseFuture<$1.MoneygramSwapResponse> swapToSolana($1.SwapToSolanaRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$swapToSolana, request, options: options);
  }

  $grpc.ResponseFuture<$1.MoneygramSwapResponse> swapToStellar($1.SwapToStellarRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$swapToStellar, request, options: options);
  }

  $grpc.ResponseFuture<$1.MoneygramFeeResponse> calculateFee($1.MoneygramFeeRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$calculateFee, request, options: options);
  }

  $grpc.ResponseFuture<$1.FundXlmResponse> fundXlm($1.FundXlmRequest request, {$grpc.CallOptions? options}) {
...
abstract class MoneygramServiceBase extends $grpc.Service {
  ...
  MoneygramServiceBase() {
    $addMethod($grpc.ServiceMethod<$1.MoneygramChallengeSignRequest, $1.MoneygramChallengeSignResponse>(
        'SignChallenge',
        signChallenge_Pre,
        false,
        false,
  ...
  $async.Future<$1.MoneygramChallengeSignResponse> signChallenge_Pre($grpc.ServiceCall $call, $async.Future<$1.MoneygramChallengeSignRequest> $request) async {
    return signChallenge($call, await $request);
  }

  $async.Future<$1.MoneygramSwapResponse> swapToSolana_Pre($grpc.ServiceCall $call, $async.Future<$1.SwapToSolanaRequest> $request) async {
    return swapToSolana($call, await $request);
  }

  $async.Future<$1.MoneygramSwapResponse> swapToStellar_Pre($grpc.ServiceCall $call, $async.Future<$1.SwapToStellarRequest> $request) async {
    return swapToStellar($call, await $request);
  }

  $async.Future<$1.MoneygramFeeResponse> calculateFee_Pre($grpc.ServiceCall $call, $async.Future<$1.MoneygramFeeRequest> $request) async {
    return calculateFee($call, await $request);
  }

  $async.Future<$1.FundXlmResponse> fundXlm_Pre($grpc.ServiceCall $call, $async.Future<$1.FundXlmRequest> $request) async {
    return fundXlm($call, await $request);
  }

  $async.Future<$1.MoneygramChallengeSignResponse> signChallenge($grpc.ServiceCall call, $1.MoneygramChallengeSignRequest request);
  $async.Future<$1.MoneygramSwapResponse> swapToSolana($grpc.ServiceCall call, $1.SwapToSolanaRequest request);
  $async.Future<$1.MoneygramSwapResponse> swapToStellar($grpc.ServiceCall call, $1.SwapToStellarRequest request);
  $async.Future<$1.MoneygramFeeResponse> calculateFee($grpc.ServiceCall call, $1.MoneygramFeeRequest request);
