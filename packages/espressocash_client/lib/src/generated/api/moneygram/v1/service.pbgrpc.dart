...
class MoneygramServiceClient extends $grpc.Client {
  static final _$signChallenge = $grpc.ClientMethod<
          $6.MoneygramChallengeSignRequest, $6.MoneygramChallengeSignResponse>(
      ...
      ($core.List<$core.int> value) =>
          $6.MoneygramChallengeSignResponse.fromBuffer(value));
  static final _$swapToSolana =
      $grpc.ClientMethod<$6.SwapToSolanaRequest, $6.MoneygramSwapResponse>(
          ...
          ($core.List<$core.int> value) =>
              $6.MoneygramSwapResponse.fromBuffer(value));
  ...
  static final _$calculateFee =
      $grpc.ClientMethod<$6.MoneygramFeeRequest, $6.MoneygramFeeResponse>(
          '/espressocash.api.moneygram.v1.MoneygramService/CalculateFee',
          ($6.MoneygramFeeRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $6.MoneygramFeeResponse.fromBuffer(value));
  static final _$fundXlm =
      $grpc.ClientMethod<$6.FundXlmRequest, $6.FundXlmResponse>(
          '/espressocash.api.moneygram.v1.MoneygramService/FundXlm',
          ($6.FundXlmRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $6.FundXlmResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$6.MoneygramSwapResponse> swapToSolana(
      $6.SwapToSolanaRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$swapToSolana, request, options: options);
  }

  $grpc.ResponseFuture<$6.MoneygramSwapResponse> swapToStellar(
      $6.SwapToStellarRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$swapToStellar, request, options: options);
  }

  $grpc.ResponseFuture<$6.MoneygramFeeResponse> calculateFee(
      $6.MoneygramFeeRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class MoneygramServiceBase extends $grpc.Service {
  ...
  MoneygramServiceBase() {
    $addMethod($grpc.ServiceMethod<$6.MoneygramChallengeSignRequest,
            $6.MoneygramChallengeSignResponse>(
        'SignChallenge',
        signChallenge_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $6.MoneygramChallengeSignRequest.fromBuffer(value),
        ($6.MoneygramChallengeSignResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$6.SwapToSolanaRequest, $6.MoneygramSwapResponse>(
            'SwapToSolana',
            swapToSolana_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $6.SwapToSolanaRequest.fromBuffer(value),
            ($6.MoneygramSwapResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$6.SwapToStellarRequest, $6.MoneygramSwapResponse>(
            'SwapToStellar',
            swapToStellar_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $6.SwapToStellarRequest.fromBuffer(value),
            ($6.MoneygramSwapResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$6.MoneygramFeeRequest, $6.MoneygramFeeResponse>(
            'CalculateFee',
            calculateFee_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $6.MoneygramFeeRequest.fromBuffer(value),
  ...
  $async.Future<$6.FundXlmResponse> fundXlm(
      $grpc.ServiceCall call, $6.FundXlmRequest request);
}
