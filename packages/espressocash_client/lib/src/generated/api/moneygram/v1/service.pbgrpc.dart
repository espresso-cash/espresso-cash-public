...
class MoneygramServiceClient extends $grpc.Client {
  ...
  static final _$signChallenge = $grpc.ClientMethod<
          $1.MoneygramChallengeSignRequest, $1.MoneygramChallengeSignResponse>(
      ...
      ($core.List<$core.int> value) =>
          $1.MoneygramChallengeSignResponse.fromBuffer(value));
  static final _$swapToSolana =
      $grpc.ClientMethod<$1.SwapToSolanaRequest, $1.MoneygramSwapResponse>(
          ...
          ($core.List<$core.int> value) =>
              $1.MoneygramSwapResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.MoneygramSwapResponse> swapToSolana(
      $1.SwapToSolanaRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$swapToSolana, request, options: options);
  }

  $grpc.ResponseFuture<$1.MoneygramSwapResponse> swapToStellar(
      $1.SwapToStellarRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$swapToStellar, request, options: options);
  }

  $grpc.ResponseFuture<$1.MoneygramFeeResponse> calculateFee(
      $1.MoneygramFeeRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class MoneygramServiceBase extends $grpc.Service {
  ...
  MoneygramServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.MoneygramChallengeSignRequest,
        ...
        ($1.MoneygramChallengeSignResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$1.SwapToSolanaRequest, $1.MoneygramSwapResponse>(
            'SwapToSolana',
            swapToSolana_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $1.SwapToSolanaRequest.fromBuffer(value),
            ($1.MoneygramSwapResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$1.SwapToStellarRequest, $1.MoneygramSwapResponse>(
            'SwapToStellar',
            swapToStellar_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $1.SwapToStellarRequest.fromBuffer(value),
            ($1.MoneygramSwapResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$1.MoneygramFeeRequest, $1.MoneygramFeeResponse>(
            'CalculateFee',
            calculateFee_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $1.MoneygramFeeRequest.fromBuffer(value),
  ...
  $async.Future<$1.FundXlmResponse> fundXlm(
      $grpc.ServiceCall call, $1.FundXlmRequest request);
}
