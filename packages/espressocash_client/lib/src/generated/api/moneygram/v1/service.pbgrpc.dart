...
class MoneygramServiceClient extends $grpc.Client {
  static final _$signChallenge = $grpc.ClientMethod<$6.MoneygramChallengeSignRequest, $6.MoneygramChallengeSignResponse>(
  ...
  static final _$swapToSolana = $grpc.ClientMethod<$6.SwapToSolanaRequest, $6.MoneygramSwapResponse>(
  ...
  static final _$swapToStellar = $grpc.ClientMethod<$6.SwapToStellarRequest, $6.MoneygramSwapResponse>(
  ...
  $grpc.ResponseFuture<$6.MoneygramChallengeSignResponse> signChallenge($6.MoneygramChallengeSignRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$signChallenge, request, options: options);
  }

  $grpc.ResponseFuture<$6.MoneygramSwapResponse> swapToSolana($6.SwapToSolanaRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$swapToSolana, request, options: options);
  }

  $grpc.ResponseFuture<$6.MoneygramSwapResponse> swapToStellar($6.SwapToStellarRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$swapToStellar, request, options: options);
  }

  $grpc.ResponseFuture<$6.MoneygramFeeResponse> calculateFee($6.MoneygramFeeRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$calculateFee, request, options: options);
  }

  $grpc.ResponseFuture<$6.FundXlmResponse> fundXlm($6.FundXlmRequest request, {$grpc.CallOptions? options}) {
...
abstract class MoneygramServiceBase extends $grpc.Service {
  ...
  MoneygramServiceBase() {
    $addMethod($grpc.ServiceMethod<$6.MoneygramChallengeSignRequest, $6.MoneygramChallengeSignResponse>(
        'SignChallenge',
        signChallenge_Pre,
        false,
        false,
  ...
  $async.Future<$6.MoneygramChallengeSignResponse> signChallenge_Pre($grpc.ServiceCall call, $async.Future<$6.MoneygramChallengeSignRequest> request) async {
    return signChallenge(call, await request);
  }

  $async.Future<$6.MoneygramSwapResponse> swapToSolana_Pre($grpc.ServiceCall call, $async.Future<$6.SwapToSolanaRequest> request) async {
    return swapToSolana(call, await request);
  }

  $async.Future<$6.MoneygramSwapResponse> swapToStellar_Pre($grpc.ServiceCall call, $async.Future<$6.SwapToStellarRequest> request) async {
    return swapToStellar(call, await request);
  }

  $async.Future<$6.MoneygramFeeResponse> calculateFee_Pre($grpc.ServiceCall call, $async.Future<$6.MoneygramFeeRequest> request) async {
    return calculateFee(call, await request);
  }

  $async.Future<$6.FundXlmResponse> fundXlm_Pre($grpc.ServiceCall call, $async.Future<$6.FundXlmRequest> request) async {
    return fundXlm(call, await request);
  }

  $async.Future<$6.MoneygramChallengeSignResponse> signChallenge($grpc.ServiceCall call, $6.MoneygramChallengeSignRequest request);
  $async.Future<$6.MoneygramSwapResponse> swapToSolana($grpc.ServiceCall call, $6.SwapToSolanaRequest request);
  $async.Future<$6.MoneygramSwapResponse> swapToStellar($grpc.ServiceCall call, $6.SwapToStellarRequest request);
  $async.Future<$6.MoneygramFeeResponse> calculateFee($grpc.ServiceCall call, $6.MoneygramFeeRequest request);
