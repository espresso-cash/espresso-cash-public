...
class LoginRequest extends $pb.GeneratedMessage {
  factory LoginRequest({
    $core.String? signerAddress,
    $core.String? walletAddress,
    $core.String? proofSignature,
    $core.String? proofMessage,
    $core.String? typeOfSigner,
  }) {
    final result = create();
    if (signerAddress != null) result.signerAddress = signerAddress;
    ...
    if (typeOfSigner != null) result.typeOfSigner = typeOfSigner;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(1, _omitFieldNames ? '' : 'signerAddress')
    ..aOS(2, _omitFieldNames ? '' : 'walletAddress')
    ..aOS(3, _omitFieldNames ? '' : 'proofSignature')
    ..aOS(4, _omitFieldNames ? '' : 'proofMessage')
    ..aOS(5, _omitFieldNames ? '' : 'typeOfSigner')
  ...
  @$pb.TagNumber(1)
  $core.String get signerAddress => $_getSZ(0);
  @$pb.TagNumber(1)
  set signerAddress($core.String value) => $_setString(0, value);
  @$pb.TagNumber(1)
  $core.bool hasSignerAddress() => $_has(0);
  @$pb.TagNumber(1)
  void clearSignerAddress() => $_clearField(1);
  ...
  @$pb.TagNumber(3)
  $core.String get proofSignature => $_getSZ(2);
  @$pb.TagNumber(3)
  set proofSignature($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
  $core.bool hasProofSignature() => $_has(2);
  @$pb.TagNumber(3)
  void clearProofSignature() => $_clearField(3);

  @$pb.TagNumber(4)
  $core.String get proofMessage => $_getSZ(3);
  @$pb.TagNumber(4)
  set proofMessage($core.String value) => $_setString(3, value);
  @$pb.TagNumber(4)
  $core.bool hasProofMessage() => $_has(3);
  @$pb.TagNumber(4)
  void clearProofMessage() => $_clearField(4);

  @$pb.TagNumber(5)
  $core.String get typeOfSigner => $_getSZ(4);
  @$pb.TagNumber(5)
  set typeOfSigner($core.String value) => $_setString(4, value);
  @$pb.TagNumber(5)
  $core.bool hasTypeOfSigner() => $_has(4);
  @$pb.TagNumber(5)
  void clearTypeOfSigner() => $_clearField(5);
}
...
class UserServiceApi {
  ...
  $async.Future<GetWalletProofMessageResponse> getWalletProofMessage(
          $pb.ClientContext? ctx, GetWalletProofMessageRequest request) =>
      _client.invoke<GetWalletProofMessageResponse>(ctx, 'UserService',
          'GetWalletProofMessage', request, GetWalletProofMessageResponse());
  $async.Future<UpdateCountryResponse> updateCountry(
          $pb.ClientContext? ctx, UpdateCountryRequest request) =>
      _client.invoke<UpdateCountryResponse>(ctx, 'UserService', 'UpdateCountry',
          request, UpdateCountryResponse());
}
