...
final $typed_data.Uint8List dlnOrderStatusDescriptor = $convert.base64Decode(
    'Cg5EbG5PcmRlclN0YXR1cxIZChVETE5fT1JERVJfU1RBVFVTX05PTkUQABIcChhETE5fT1JERV'
...
const GetOutgoingQuoteRequest$json = {
  ...
  '2': [
    ...
    {
      '1': 'receiver_blockchain',
      '3': 3,
      '4': 1,
      '5': 9,
      '10': 'receiverBlockchain'
    },
  ],
};

/// Descriptor for `GetOutgoingQuoteRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getOutgoingQuoteRequestDescriptor = $convert.base64Decode(
    'ChdHZXRPdXRnb2luZ1F1b3RlUmVxdWVzdBIWCgZhbW91bnQYASABKANSBmFtb3VudBIpChByZW'
...
final $typed_data.Uint8List getOutgoingQuoteResponseDescriptor = $convert.base64Decode(
    'ChhHZXRPdXRnb2luZ1F1b3RlUmVzcG9uc2USIQoMaW5wdXRfYW1vdW50GAEgASgDUgtpbnB1dE'
...
final $typed_data.Uint8List getOrderStatusRequestDescriptor =
    $convert.base64Decode(
        'ChVHZXRPcmRlclN0YXR1c1JlcXVlc3QSGQoIb3JkZXJfaWQYASABKAlSB29yZGVySWQ=');
...
final $typed_data.Uint8List getOrderStatusResponseDescriptor =
    $convert.base64Decode(
        'ChZHZXRPcmRlclN0YXR1c1Jlc3BvbnNlEj8KBnN0YXR1cxgBIAEoDjInLmVzcHJlc3NvY2FzaC'
...
final $typed_data.Uint8List getOrderIdRequestDescriptor = $convert
    .base64Decode('ChFHZXRPcmRlcklkUmVxdWVzdBITCgV0eF9pZBgBIAEoCVIEdHhJZA==');
...
final $typed_data.Uint8List getOrderIdResponseDescriptor = $convert.base64Decode(
    'ChJHZXRPcmRlcklkUmVzcG9uc2USHgoIb3JkZXJfaWQYASABKAlIAFIHb3JkZXJJZIgBAUILCg'
    'lfb3JkZXJfaWQ=');
...
final $typed_data.Uint8List getIncomingQuoteRequestDescriptor = $convert.base64Decode(
    'ChdHZXRJbmNvbWluZ1F1b3RlUmVxdWVzdBIWCgZhbW91bnQYASABKANSBmFtb3VudBIlCg5zZW'
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.espressocash.api.dln.v1.QuoteTx',
      '10': 'tx'
    },
    {
      '1': 'usdc_info',
...
final $typed_data.Uint8List getIncomingQuoteResponseDescriptor = $convert.base64Decode(
    'ChhHZXRJbmNvbWluZ1F1b3RlUmVzcG9uc2USMAoCdHgYASABKAsyIC5lc3ByZXNzb2Nhc2guYX'
...
final $typed_data.Uint8List quoteTxDescriptor = $convert.base64Decode(
    'CgdRdW90ZVR4Eg4KAnRvGAEgASgJUgJ0bxISCgRkYXRhGAIgASgJUgRkYXRhEhQKBXZhbHVlGA'
    'MgASgDUgV2YWx1ZQ==');
...
final $typed_data.Uint8List quoteUsdcInfoDescriptor = $convert.base64Decode(
    'Cg1RdW90ZVVzZGNJbmZvEiEKDHVzZGNfYWRkcmVzcxgBIAEoCVILdXNkY0FkZHJlc3MSJwoPYX'
...
final $typed_data.Uint8List getGasFeesRequestDescriptor = $convert.base64Decode(
    'ChFHZXRHYXNGZWVzUmVxdWVzdBIYCgduZXR3b3JrGAEgASgJUgduZXR3b3Jr');
...
final $typed_data.Uint8List getGasFeesResponseDescriptor = $convert.base64Decode(
    'ChJHZXRHYXNGZWVzUmVzcG9uc2USOQoDbG93GAEgASgLMicuZXNwcmVzc29jYXNoLmFwaS5kbG'
...
const GasFeeEstimate$json = {
  ...
  '2': [
    ...
    {
      '1': 'suggested_max_fee_per_gas',
      '3': 2,
      '4': 1,
      '5': 9,
      '10': 'suggestedMaxFeePerGas'
    },
    {
      '1': 'min_wait_time_estimate',
      '3': 3,
      '4': 1,
      '5': 5,
      '10': 'minWaitTimeEstimate'
    },
    {
      '1': 'max_wait_time_estimate',
      '3': 4,
      '4': 1,
      '5': 5,
      '10': 'maxWaitTimeEstimate'
    },
  ],
};

/// Descriptor for `GasFeeEstimate`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gasFeeEstimateDescriptor = $convert.base64Decode(
    'Cg5HYXNGZWVFc3RpbWF0ZRJJCiJzdWdnZXN0ZWRfbWF4X3ByaW9yaXR5X2ZlZV9wZXJfZ2FzGA'
...
const $core.Map<$core.String, $core.dynamic> DlnServiceBase$json = {
  '1': 'DlnService',
  '2': [
    {
      '1': 'GetOutgoingQuote',
      '2': '.espressocash.api.dln.v1.GetOutgoingQuoteRequest',
      '3': '.espressocash.api.dln.v1.GetOutgoingQuoteResponse'
    },
    {
      '1': 'GetIncomingQuote',
      '2': '.espressocash.api.dln.v1.GetIncomingQuoteRequest',
      '3': '.espressocash.api.dln.v1.GetIncomingQuoteResponse'
    },
    {
      '1': 'GetOrderId',
      '2': '.espressocash.api.dln.v1.GetOrderIdRequest',
      '3': '.espressocash.api.dln.v1.GetOrderIdResponse'
    },
    {
      '1': 'GetOrderStatus',
      '2': '.espressocash.api.dln.v1.GetOrderStatusRequest',
      '3': '.espressocash.api.dln.v1.GetOrderStatusResponse'
    },
    {
      '1': 'GetGasFees',
      '2': '.espressocash.api.dln.v1.GetGasFeesRequest',
      '3': '.espressocash.api.dln.v1.GetGasFeesResponse'
    },
  ],
};

@$core.Deprecated('Use dlnServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
    DlnServiceBase$messageJson = {
  '.espressocash.api.dln.v1.GetOutgoingQuoteRequest':
      GetOutgoingQuoteRequest$json,
  '.espressocash.api.dln.v1.GetOutgoingQuoteResponse':
      GetOutgoingQuoteResponse$json,
  '.espressocash.api.dln.v1.GetIncomingQuoteRequest':
      GetIncomingQuoteRequest$json,
  '.espressocash.api.dln.v1.GetIncomingQuoteResponse':
      GetIncomingQuoteResponse$json,
  '.espressocash.api.dln.v1.QuoteTx': QuoteTx$json,
  '.espressocash.api.dln.v1.QuoteUsdcInfo': QuoteUsdcInfo$json,
  '.espressocash.api.dln.v1.GetOrderIdRequest': GetOrderIdRequest$json,
  '.espressocash.api.dln.v1.GetOrderIdResponse': GetOrderIdResponse$json,
  '.espressocash.api.dln.v1.GetOrderStatusRequest': GetOrderStatusRequest$json,
  '.espressocash.api.dln.v1.GetOrderStatusResponse':
      GetOrderStatusResponse$json,
  '.espressocash.api.dln.v1.GetGasFeesRequest': GetGasFeesRequest$json,
  '.espressocash.api.dln.v1.GetGasFeesResponse': GetGasFeesResponse$json,
  '.espressocash.api.dln.v1.GasFeeEstimate': GasFeeEstimate$json,
};

/// Descriptor for `DlnService`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List dlnServiceDescriptor = $convert.base64Decode(
    'CgpEbG5TZXJ2aWNlEncKEEdldE91dGdvaW5nUXVvdGUSMC5lc3ByZXNzb2Nhc2guYXBpLmRsbi'
    '52MS5HZXRPdXRnb2luZ1F1b3RlUmVxdWVzdBoxLmVzcHJlc3NvY2FzaC5hcGkuZGxuLnYxLkdl'
    'dE91dGdvaW5nUXVvdGVSZXNwb25zZRJ3ChBHZXRJbmNvbWluZ1F1b3RlEjAuZXNwcmVzc29jYX'
    'NoLmFwaS5kbG4udjEuR2V0SW5jb21pbmdRdW90ZVJlcXVlc3QaMS5lc3ByZXNzb2Nhc2guYXBp'
    'LmRsbi52MS5HZXRJbmNvbWluZ1F1b3RlUmVzcG9uc2USZQoKR2V0T3JkZXJJZBIqLmVzcHJlc3'
    'NvY2FzaC5hcGkuZGxuLnYxLkdldE9yZGVySWRSZXF1ZXN0GisuZXNwcmVzc29jYXNoLmFwaS5k'
    'bG4udjEuR2V0T3JkZXJJZFJlc3BvbnNlEnEKDkdldE9yZGVyU3RhdHVzEi4uZXNwcmVzc29jYX'
    'NoLmFwaS5kbG4udjEuR2V0T3JkZXJTdGF0dXNSZXF1ZXN0Gi8uZXNwcmVzc29jYXNoLmFwaS5k'
    'bG4udjEuR2V0T3JkZXJTdGF0dXNSZXNwb25zZRJlCgpHZXRHYXNGZWVzEiouZXNwcmVzc29jYX'
    'NoLmFwaS5kbG4udjEuR2V0R2FzRmVlc1JlcXVlc3QaKy5lc3ByZXNzb2Nhc2guYXBpLmRsbi52'
    'MS5HZXRHYXNGZWVzUmVzcG9uc2U=');
