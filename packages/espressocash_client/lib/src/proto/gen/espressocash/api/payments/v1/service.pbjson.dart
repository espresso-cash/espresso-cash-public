...
final $typed_data.Uint8List createDirectPaymentResponseDescriptor =
...
final $typed_data.Uint8List getDirectPaymentQuoteRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getDirectPaymentQuoteResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List createEscrowPaymentRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List createEscrowPaymentResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List receiveEscrowPaymentRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List receiveEscrowPaymentResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List cancelEscrowPaymentRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List cancelEscrowPaymentResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getIncomingEscrowPaymentQuoteRequestDescriptor =
    $convert
        .base64Decode('CiRHZXRJbmNvbWluZ0VzY3Jvd1BheW1lbnRRdW90ZVJlcXVlc3Q=');
...
final $typed_data.Uint8List getIncomingEscrowPaymentQuoteResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getOutgoingEscrowPaymentQuoteRequestDescriptor =
    $convert
        .base64Decode('CiRHZXRPdXRnb2luZ0VzY3Jvd1BheW1lbnRRdW90ZVJlcXVlc3Q=');
...
final $typed_data.Uint8List getOutgoingEscrowPaymentQuoteResponseDescriptor =
    $convert.base64Decode(
...
const $core.Map<$core.String, $core.dynamic> PaymentServiceBase$json = {
  ...
  '2': [
    {
      '1': 'CreateDirectPayment',
      '2': '.espressocash.api.payments.v1.CreateDirectPaymentRequest',
      '3': '.espressocash.api.payments.v1.CreateDirectPaymentResponse'
    },
    {
      '1': 'GetDirectPaymentQuote',
      '2': '.espressocash.api.payments.v1.GetDirectPaymentQuoteRequest',
      '3': '.espressocash.api.payments.v1.GetDirectPaymentQuoteResponse'
    },
    {
      '1': 'CreateEscrowPayment',
      '2': '.espressocash.api.payments.v1.CreateEscrowPaymentRequest',
      '3': '.espressocash.api.payments.v1.CreateEscrowPaymentResponse'
    },
    {
      '1': 'ReceiveEscrowPayment',
      '2': '.espressocash.api.payments.v1.ReceiveEscrowPaymentRequest',
      '3': '.espressocash.api.payments.v1.ReceiveEscrowPaymentResponse'
    },
    {
      '1': 'CancelEscrowPayment',
      '2': '.espressocash.api.payments.v1.CancelEscrowPaymentRequest',
      '3': '.espressocash.api.payments.v1.CancelEscrowPaymentResponse'
    },
    {
      '1': 'GetOutgoingEscrowPaymentQuote',
      '2': '.espressocash.api.payments.v1.GetOutgoingEscrowPaymentQuoteRequest',
      '3': '.espressocash.api.payments.v1.GetOutgoingEscrowPaymentQuoteResponse'
    },
    {
      '1': 'GetIncomingEscrowPaymentQuote',
      '2': '.espressocash.api.payments.v1.GetIncomingEscrowPaymentQuoteRequest',
      '3': '.espressocash.api.payments.v1.GetIncomingEscrowPaymentQuoteResponse'
    },
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
  ...
  '.espressocash.api.payments.v1.CreateDirectPaymentRequest':
      CreateDirectPaymentRequest$json,
  '.espressocash.api.payments.v1.CreateDirectPaymentResponse':
      CreateDirectPaymentResponse$json,
  '.espressocash.api.payments.v1.GetDirectPaymentQuoteRequest':
      GetDirectPaymentQuoteRequest$json,
  '.espressocash.api.payments.v1.GetDirectPaymentQuoteResponse':
      GetDirectPaymentQuoteResponse$json,
  '.espressocash.api.payments.v1.CreateEscrowPaymentRequest':
      CreateEscrowPaymentRequest$json,
  '.espressocash.api.payments.v1.CreateEscrowPaymentResponse':
      CreateEscrowPaymentResponse$json,
  '.espressocash.api.payments.v1.ReceiveEscrowPaymentRequest':
      ReceiveEscrowPaymentRequest$json,
  '.espressocash.api.payments.v1.ReceiveEscrowPaymentResponse':
      ReceiveEscrowPaymentResponse$json,
  '.espressocash.api.payments.v1.CancelEscrowPaymentRequest':
      CancelEscrowPaymentRequest$json,
  '.espressocash.api.payments.v1.CancelEscrowPaymentResponse':
      CancelEscrowPaymentResponse$json,
  '.espressocash.api.payments.v1.GetOutgoingEscrowPaymentQuoteRequest':
      GetOutgoingEscrowPaymentQuoteRequest$json,
  '.espressocash.api.payments.v1.GetOutgoingEscrowPaymentQuoteResponse':
      GetOutgoingEscrowPaymentQuoteResponse$json,
  '.espressocash.api.payments.v1.GetIncomingEscrowPaymentQuoteRequest':
      GetIncomingEscrowPaymentQuoteRequest$json,
  '.espressocash.api.payments.v1.GetIncomingEscrowPaymentQuoteResponse':
      GetIncomingEscrowPaymentQuoteResponse$json,
};
...
final $typed_data.Uint8List paymentServiceDescriptor = $convert.base64Decode(
    'Cg5QYXltZW50U2VydmljZRKKAQoTQ3JlYXRlRGlyZWN0UGF5bWVudBI4LmVzcHJlc3NvY2FzaC'
    '5hcGkucGF5bWVudHMudjEuQ3JlYXRlRGlyZWN0UGF5bWVudFJlcXVlc3QaOS5lc3ByZXNzb2Nh'
    'c2guYXBpLnBheW1lbnRzLnYxLkNyZWF0ZURpcmVjdFBheW1lbnRSZXNwb25zZRKQAQoVR2V0RG'
    'lyZWN0UGF5bWVudFF1b3RlEjouZXNwcmVzc29jYXNoLmFwaS5wYXltZW50cy52MS5HZXREaXJl'
    'Y3RQYXltZW50UXVvdGVSZXF1ZXN0GjsuZXNwcmVzc29jYXNoLmFwaS5wYXltZW50cy52MS5HZX'
    'REaXJlY3RQYXltZW50UXVvdGVSZXNwb25zZRKKAQoTQ3JlYXRlRXNjcm93UGF5bWVudBI4LmVz'
    'cHJlc3NvY2FzaC5hcGkucGF5bWVudHMudjEuQ3JlYXRlRXNjcm93UGF5bWVudFJlcXVlc3QaOS'
    '5lc3ByZXNzb2Nhc2guYXBpLnBheW1lbnRzLnYxLkNyZWF0ZUVzY3Jvd1BheW1lbnRSZXNwb25z'
    'ZRKNAQoUUmVjZWl2ZUVzY3Jvd1BheW1lbnQSOS5lc3ByZXNzb2Nhc2guYXBpLnBheW1lbnRzLn'
    'YxLlJlY2VpdmVFc2Nyb3dQYXltZW50UmVxdWVzdBo6LmVzcHJlc3NvY2FzaC5hcGkucGF5bWVu'
    'dHMudjEuUmVjZWl2ZUVzY3Jvd1BheW1lbnRSZXNwb25zZRKKAQoTQ2FuY2VsRXNjcm93UGF5bW'
    'VudBI4LmVzcHJlc3NvY2FzaC5hcGkucGF5bWVudHMudjEuQ2FuY2VsRXNjcm93UGF5bWVudFJl'
    'cXVlc3QaOS5lc3ByZXNzb2Nhc2guYXBpLnBheW1lbnRzLnYxLkNhbmNlbEVzY3Jvd1BheW1lbn'
    'RSZXNwb25zZRKoAQodR2V0T3V0Z29pbmdFc2Nyb3dQYXltZW50UXVvdGUSQi5lc3ByZXNzb2Nh'
    'c2guYXBpLnBheW1lbnRzLnYxLkdldE91dGdvaW5nRXNjcm93UGF5bWVudFF1b3RlUmVxdWVzdB'
    'pDLmVzcHJlc3NvY2FzaC5hcGkucGF5bWVudHMudjEuR2V0T3V0Z29pbmdFc2Nyb3dQYXltZW50'
    'UXVvdGVSZXNwb25zZRKoAQodR2V0SW5jb21pbmdFc2Nyb3dQYXltZW50UXVvdGUSQi5lc3ByZX'
    'Nzb2Nhc2guYXBpLnBheW1lbnRzLnYxLkdldEluY29taW5nRXNjcm93UGF5bWVudFF1b3RlUmVx'
    'dWVzdBpDLmVzcHJlc3NvY2FzaC5hcGkucGF5bWVudHMudjEuR2V0SW5jb21pbmdFc2Nyb3dQYX'
    'ltZW50UXVvdGVSZXNwb25zZQ==');
