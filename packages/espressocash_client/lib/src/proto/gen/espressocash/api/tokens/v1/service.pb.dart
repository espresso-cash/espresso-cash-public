...
class TokensServiceApi {
  final $pb.RpcClient _client;

  TokensServiceApi(this._client);

  $async.Future<GetTokensMetaResponse> getTokensMeta(
          $pb.ClientContext? ctx, GetTokensMetaRequest request) =>
      _client.invoke<GetTokensMetaResponse>(ctx, 'TokensService',
          'GetTokensMeta', request, GetTokensMetaResponse());
  $async.Future<GetTokensFileResponse> getTokensFile(
          $pb.ClientContext? ctx, GetTokensFileRequest request) =>
      _client.invoke<GetTokensFileResponse>(ctx, 'TokensService',
          'GetTokensFile', request, GetTokensFileResponse());
}
