...
class GasFeeEstimate extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set suggestedMaxPriorityFeePerGas($core.String value) =>
      $_setString(0, value);
  @$pb.TagNumber(1)
...
class DlnServiceApi {
  ...
  DlnServiceApi(this._client);

  $async.Future<GetOutgoingQuoteResponse> getOutgoingQuote(
          $pb.ClientContext? ctx, GetOutgoingQuoteRequest request) =>
      _client.invoke<GetOutgoingQuoteResponse>(ctx, 'DlnService',
          'GetOutgoingQuote', request, GetOutgoingQuoteResponse());
  $async.Future<GetIncomingQuoteResponse> getIncomingQuote(
          $pb.ClientContext? ctx, GetIncomingQuoteRequest request) =>
      _client.invoke<GetIncomingQuoteResponse>(ctx, 'DlnService',
          'GetIncomingQuote', request, GetIncomingQuoteResponse());
  $async.Future<GetOrderIdResponse> getOrderId(
          $pb.ClientContext? ctx, GetOrderIdRequest request) =>
      _client.invoke<GetOrderIdResponse>(
          ctx, 'DlnService', 'GetOrderId', request, GetOrderIdResponse());
  $async.Future<GetOrderStatusResponse> getOrderStatus(
          $pb.ClientContext? ctx, GetOrderStatusRequest request) =>
      _client.invoke<GetOrderStatusResponse>(ctx, 'DlnService',
          'GetOrderStatus', request, GetOrderStatusResponse());
  $async.Future<GetGasFeesResponse> getGasFees(
          $pb.ClientContext? ctx, GetGasFeesRequest request) =>
      _client.invoke<GetGasFeesResponse>(
          ctx, 'DlnService', 'GetGasFees', request, GetGasFeesResponse());
}
