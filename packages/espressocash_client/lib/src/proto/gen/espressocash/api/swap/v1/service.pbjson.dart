...
final $typed_data.Uint8List swapMatchDescriptor = $convert.base64Decode(
    'CglTd2FwTWF0Y2gSGgoWU1dBUF9NQVRDSF9VTlNQRUNJRklFRBAAEhgKFFNXQVBfTUFUQ0hfSU'
...
final $typed_data.Uint8List swapSlippageDescriptor = $convert.base64Decode(
    'CgxTd2FwU2xpcHBhZ2USHQoZU1dBUF9TTElQUEFHRV9VTlNQRUNJRklFRBAAEhgKFFNXQVBfU0'
...
final $typed_data.Uint8List swapRouteRequestDescriptor = $convert.base64Decode(
    'ChBTd2FwUm91dGVSZXF1ZXN0Eh8KC2lucHV0X3Rva2VuGAEgASgJUgppbnB1dFRva2VuEiEKDG'
...
final $typed_data.Uint8List swapRouteResponseDescriptor = $convert.base64Decode(
    'ChFTd2FwUm91dGVSZXNwb25zZRIbCglpbl9hbW91bnQYASABKAlSCGluQW1vdW50Eh0KCm91dF'
...
const $core.Map<$core.String, $core.dynamic> SwapServiceBase$json = {
  '1': 'SwapService',
  '2': [
    {
      '1': 'Swap',
      '2': '.espressocash.api.swap.v1.SwapRouteRequest',
      '3': '.espressocash.api.swap.v1.SwapRouteResponse'
    },
  ],
};

@$core.Deprecated('Use swapServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
    SwapServiceBase$messageJson = {
  '.espressocash.api.swap.v1.SwapRouteRequest': SwapRouteRequest$json,
  '.espressocash.api.swap.v1.SwapRouteResponse': SwapRouteResponse$json,
};

/// Descriptor for `SwapService`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List swapServiceDescriptor = $convert.base64Decode(
    'CgtTd2FwU2VydmljZRJfCgRTd2FwEiouZXNwcmVzc29jYXNoLmFwaS5zd2FwLnYxLlN3YXBSb3'
    'V0ZVJlcXVlc3QaKy5lc3ByZXNzb2Nhc2guYXBpLnN3YXAudjEuU3dhcFJvdXRlUmVzcG9uc2U=');
