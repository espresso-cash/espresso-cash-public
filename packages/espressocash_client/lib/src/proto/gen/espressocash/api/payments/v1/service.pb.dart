...
class PaymentServiceApi {
  ...
  $async.Future<CreateDirectPaymentResponse> createDirectPayment(
          $pb.ClientContext? ctx, CreateDirectPaymentRequest request) =>
      _client.invoke<CreateDirectPaymentResponse>(ctx, 'PaymentService',
          'CreateDirectPayment', request, CreateDirectPaymentResponse());
  $async.Future<GetDirectPaymentQuoteResponse> getDirectPaymentQuote(
          $pb.ClientContext? ctx, GetDirectPaymentQuoteRequest request) =>
      _client.invoke<GetDirectPaymentQuoteResponse>(ctx, 'PaymentService',
          'GetDirectPaymentQuote', request, GetDirectPaymentQuoteResponse());
  $async.Future<CreateEscrowPaymentResponse> createEscrowPayment(
          $pb.ClientContext? ctx, CreateEscrowPaymentRequest request) =>
      _client.invoke<CreateEscrowPaymentResponse>(ctx, 'PaymentService',
          'CreateEscrowPayment', request, CreateEscrowPaymentResponse());
  $async.Future<ReceiveEscrowPaymentResponse> receiveEscrowPayment(
          $pb.ClientContext? ctx, ReceiveEscrowPaymentRequest request) =>
      _client.invoke<ReceiveEscrowPaymentResponse>(ctx, 'PaymentService',
          'ReceiveEscrowPayment', request, ReceiveEscrowPaymentResponse());
  $async.Future<CancelEscrowPaymentResponse> cancelEscrowPayment(
          $pb.ClientContext? ctx, CancelEscrowPaymentRequest request) =>
      _client.invoke<CancelEscrowPaymentResponse>(ctx, 'PaymentService',
          'CancelEscrowPayment', request, CancelEscrowPaymentResponse());
  $async.Future<GetOutgoingEscrowPaymentQuoteResponse>
      getOutgoingEscrowPaymentQuote($pb.ClientContext? ctx,
              GetOutgoingEscrowPaymentQuoteRequest request) =>
          _client.invoke<GetOutgoingEscrowPaymentQuoteResponse>(
              ctx,
              'PaymentService',
              'GetOutgoingEscrowPaymentQuote',
              request,
              GetOutgoingEscrowPaymentQuoteResponse());
  $async.Future<GetIncomingEscrowPaymentQuoteResponse>
      getIncomingEscrowPaymentQuote($pb.ClientContext? ctx,
              GetIncomingEscrowPaymentQuoteRequest request) =>
          _client.invoke<GetIncomingEscrowPaymentQuoteResponse>(
              ctx,
              'PaymentService',
              'GetIncomingEscrowPaymentQuote',
              request,
              GetIncomingEscrowPaymentQuoteResponse());
}
