...
class GetRatesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'espressocash.api.rates.v1'),
  ...
  static $pb.PbList<GetRatesRequest> createRepeated() =>
      $pb.PbList<GetRatesRequest>();
  @$core.pragma('dart2js:noInline')
...
class GetRatesResponse extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<GetRatesResponse> createRepeated() =>
      $pb.PbList<GetRatesResponse>();
  @$core.pragma('dart2js:noInline')
...
class GetFiatRatesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetFiatRatesRequest',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'espressocash.api.rates.v1'),
      createEmptyInstance: create)
  ...
  GetFiatRatesRequest copyWith(void Function(GetFiatRatesRequest) updates) =>
      super.copyWith((message) => updates(message as GetFiatRatesRequest))
          as GetFiatRatesRequest;
  ...
  static $pb.PbList<GetFiatRatesRequest> createRepeated() =>
      $pb.PbList<GetFiatRatesRequest>();
  @$core.pragma('dart2js:noInline')
  static GetFiatRatesRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetFiatRatesRequest>(create);
...
class GetFiatRatesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetFiatRatesResponse',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'espressocash.api.rates.v1'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetFiatRatesResponse clone() =>
      GetFiatRatesResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetFiatRatesResponse copyWith(void Function(GetFiatRatesResponse) updates) =>
      super.copyWith((message) => updates(message as GetFiatRatesResponse))
          as GetFiatRatesResponse;
  ...
  static $pb.PbList<GetFiatRatesResponse> createRepeated() =>
      $pb.PbList<GetFiatRatesResponse>();
  @$core.pragma('dart2js:noInline')
  static GetFiatRatesResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetFiatRatesResponse>(create);
...
class RateServiceApi {
  ...
  RateServiceApi(this._client);

  $async.Future<GetRatesResponse> getRates(
          $pb.ClientContext? ctx, GetRatesRequest request) =>
      _client.invoke<GetRatesResponse>(
          ctx, 'RateService', 'GetRates', request, GetRatesResponse());
  $async.Future<GetFiatRatesResponse> getFiatRates(
          $pb.ClientContext? ctx, GetFiatRatesRequest request) =>
      _client.invoke<GetFiatRatesResponse>(
          ctx, 'RateService', 'GetFiatRates', request, GetFiatRatesResponse());
}
