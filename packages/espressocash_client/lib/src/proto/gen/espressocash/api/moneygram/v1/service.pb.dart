...
class MoneygramServiceApi {
  final $pb.RpcClient _client;

  MoneygramServiceApi(this._client);

  $async.Future<MoneygramChallengeSignResponse> signChallenge(
          $pb.ClientContext? ctx, MoneygramChallengeSignRequest request) =>
      _client.invoke<MoneygramChallengeSignResponse>(ctx, 'MoneygramService',
          'SignChallenge', request, MoneygramChallengeSignResponse());
  $async.Future<MoneygramSwapResponse> swapToSolana(
          $pb.ClientContext? ctx, SwapToSolanaRequest request) =>
      _client.invoke<MoneygramSwapResponse>(ctx, 'MoneygramService',
          'SwapToSolana', request, MoneygramSwapResponse());
  $async.Future<MoneygramSwapResponse> swapToStellar(
          $pb.ClientContext? ctx, SwapToStellarRequest request) =>
      _client.invoke<MoneygramSwapResponse>(ctx, 'MoneygramService',
          'SwapToStellar', request, MoneygramSwapResponse());
  $async.Future<MoneygramFeeResponse> calculateFee(
          $pb.ClientContext? ctx, MoneygramFeeRequest request) =>
      _client.invoke<MoneygramFeeResponse>(ctx, 'MoneygramService',
          'CalculateFee', request, MoneygramFeeResponse());
  $async.Future<FundXlmResponse> fundXlm(
          $pb.ClientContext? ctx, FundXlmRequest request) =>
      _client.invoke<FundXlmResponse>(
          ctx, 'MoneygramService', 'FundXlm', request, FundXlmResponse());
}
