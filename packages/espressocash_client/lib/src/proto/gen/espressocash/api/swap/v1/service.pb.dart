...
class SwapRouteRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SwapRouteRequest',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'espressocash.api.swap.v1'),
  ...
  SwapRouteRequest copyWith(void Function(SwapRouteRequest) updates) =>
      super.copyWith((message) => updates(message as SwapRouteRequest))
          as SwapRouteRequest;
  ...
  static $pb.PbList<SwapRouteRequest> createRepeated() =>
      $pb.PbList<SwapRouteRequest>();
  @$core.pragma('dart2js:noInline')
  static SwapRouteRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SwapRouteRequest>(create);
...
class SwapRouteResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SwapRouteResponse',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'espressocash.api.swap.v1'),
      createEmptyInstance: create)
    ...
    ..a<$core.int>(
        8, _omitFieldNames ? '' : 'platformFeeBps', $pb.PbFieldType.O3)
  ...
  SwapRouteResponse copyWith(void Function(SwapRouteResponse) updates) =>
      super.copyWith((message) => updates(message as SwapRouteResponse))
  ...
  static $pb.PbList<SwapRouteResponse> createRepeated() =>
      $pb.PbList<SwapRouteResponse>();
  @$core.pragma('dart2js:noInline')
  static SwapRouteResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SwapRouteResponse>(create);
...
class SwapServiceApi {
  ...
  SwapServiceApi(this._client);

  $async.Future<SwapRouteResponse> swap(
          $pb.ClientContext? ctx, SwapRouteRequest request) =>
      _client.invoke<SwapRouteResponse>(
          ctx, 'SwapService', 'Swap', request, SwapRouteResponse());
}
