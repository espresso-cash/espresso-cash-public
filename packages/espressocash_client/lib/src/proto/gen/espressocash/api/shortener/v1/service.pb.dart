...
class ShortenerServiceApi {
  final $pb.RpcClient _client;

  ShortenerServiceApi(this._client);

  $async.Future<ShortenLinkResponse> shortenLink(
          $pb.ClientContext? ctx, ShortenLinkRequest request) =>
      _client.invoke<ShortenLinkResponse>(ctx, 'ShortenerService',
          'ShortenLink', request, ShortenLinkResponse());
  $async.Future<ExpandLinkResponse> expandLink(
          $pb.ClientContext? ctx, ExpandLinkRequest request) =>
      _client.invoke<ExpandLinkResponse>(
          ctx, 'ShortenerService', 'ExpandLink', request, ExpandLinkResponse());
}
