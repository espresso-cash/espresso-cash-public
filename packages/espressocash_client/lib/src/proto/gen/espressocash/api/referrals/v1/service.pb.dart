...
class ReferralServiceApi {
  ...
  ReferralServiceApi(this._client);

  $async.Future<AddReferralResponse> addReferral(
          $pb.ClientContext? ctx, AddReferralRequest request) =>
      _client.invoke<AddReferralResponse>(ctx, 'ReferralService', 'AddReferral',
          request, AddReferralResponse());
  $async.Future<GetStatsResponse> getStats(
          $pb.ClientContext? ctx, GetStatsRequest request) =>
      _client.invoke<GetStatsResponse>(
          ctx, 'ReferralService', 'GetStats', request, GetStatsResponse());
  $async.Future<VerifyResponse> verify(
          $pb.ClientContext? ctx, VerifyRequest request) =>
      _client.invoke<VerifyResponse>(
          ctx, 'ReferralService', 'Verify', request, VerifyResponse());
}
