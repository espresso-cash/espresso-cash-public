...
@freezed
abstract class ShortenLinkRequestDto with _$ShortenLinkRequestDto {
  const factory ShortenLinkRequestDto({required String fullLink}) = _ShortenLinkRequestDto;
}

@freezed
abstract class ShortenLinkResponseDto with _$ShortenLinkResponseDto {
  const factory ShortenLinkResponseDto({required String shortLink}) = _ShortenLinkResponseDto;
}

@freezed
abstract class UnshortenLinkRequestDto with _$UnshortenLinkRequestDto {
  const factory UnshortenLinkRequestDto({required String shortLink}) = _UnshortenLinkRequestDto;
}

@freezed
abstract class UnshortenLinkResponseDto with _$UnshortenLinkResponseDto {
