...
class SeedVaultBloc extends Cubit<SeedVaultState> {
  ...
  Future<void> init() async {
    final isInstalled = await SeedVault.instance.isAvailable(
      allowSimulated: true,
    );
    ...
    if (granted) {
      _subscription = SeedVault.instance.notificationStream.listen(
        (_) => refreshUI(),
      );
  ...
  Future<void> refreshUI() async {
    ...
    emit(
      SeedVaultState.loaded(
        ...
        hasUnauthorizedSeeds: await SeedVault.instance
  ...
  AsyncResult<String> exceedMaxSigningRequests(AuthToken authToken) async =>
      _signTransactions(
        authToken: authToken,
        signingRequests: await _generateSigningRequests(
          authToken: authToken,
  ...
  AsyncResult<String> exceedMaxRequestedSignatures(AuthToken authToken) async =>
      _signTransactions(
        authToken: authToken,
        signingRequests: await _generateSigningRequests(
          authToken: authToken,
