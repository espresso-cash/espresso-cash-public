...
class _WalletApiHostCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    ...
    } else if (value is AccountFilterDto) {
      buffer.putUint8(129);
      writeValue(buffer, value.encode());
    } else if (value is ImplementationLimitsDto) {
      buffer.putUint8(130);
      writeValue(buffer, value.encode());
    } else if (value is PublicKeyResponseDto) {
      buffer.putUint8(131);
      writeValue(buffer, value.encode());
...
class WalletApiHost {
  ...
  Future<List<AccountDto?>> getAccounts(
      int arg_authToken, AccountFilterDto? arg_filter) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.WalletApiHost.getAccounts', codec,
        binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap = await channel
        .send(<Object?>[arg_authToken, arg_filter]) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
...
class Bip32ApiHost {
  ...
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  Bip32ApiHost({BinaryMessenger? binaryMessenger})
      : _binaryMessenger = binaryMessenger;
  ...
  Future<List<BipLevelDto?>> fromUri(String arg_uri) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.Bip32ApiHost.fromUri', codec,
        binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
  ...
  Future<String> toUri(List<BipLevelDto?> arg_levels) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.Bip32ApiHost.toUri', codec,
        binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
...
class Bip44ApiHost {
  ...
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  Bip44ApiHost({BinaryMessenger? binaryMessenger})
      : _binaryMessenger = binaryMessenger;
  ...
  Future<Bip44DerivationDto> fromUri(String arg_uri) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.Bip44ApiHost.fromUri', codec,
        binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object?>[arg_uri]) as Map<Object?, Object?>?;
    if (replyMap == null) {
  ...
  Future<String> toUri(Bip44DerivationDto arg_levels) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.Bip44ApiHost.toUri', codec,
        binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object?>[arg_levels]) as Map<Object?, Object?>?;
    if (replyMap == null) {
...
class SeedVaultApiHost {
  ...
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  SeedVaultApiHost({BinaryMessenger? binaryMessenger})
      : _binaryMessenger = binaryMessenger;
  ...
  Future<bool> isAvailable(bool arg_allowSimulated) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.SeedVaultApiHost.isAvailable', codec,
        binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap = await channel
  ...
  Future<bool> checkPermission() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.SeedVaultApiHost.checkPermission', codec,
        binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(null) as Map<Object?, Object?>?;
    if (replyMap == null) {
