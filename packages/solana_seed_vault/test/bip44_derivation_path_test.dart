...
void main() {
  group('Should succeed to convert valid BipLevels to BIP44 Uri', () {
    test('Convert single hardened BipLevel to BIP44 Uri', () {
    ...
    test('Convert single non-hardened BipLevel to BIP44 Uri', () {
  ...
  group('Should succeed to convert valid BIP44 Uri to BipLevels', () {
    test('Convert BIP44 Uri to account BipLevel only', () {
    ...
    test('Convert BIP44 Uri to multiple BipLevels', () {
