...
void main() {
  ...
  final List<int> aBytes = [
    0x04, 0xfe, 0xdf, 0x98, 0xa7, 0xfa, 0x0a, 0x68, 0x84, 0x92, 0xbd, 0x59, //
    0x08, 0x07, 0xa7, 0x03, 0x9e, 0xd1, 0xf6, 0xf2, 0xe1, 0xd9, 0xe2, 0xa4, //
    0xa4, 0x51, 0x47, 0x36, 0xf3, 0xc3, 0xa9, 0x17
  ];
  // Byte representation of a**2
  final List<int> aSquaredBytes = [
    0x75, 0x97, 0x24, 0x9e, 0xe6, 0x06, 0xfe, 0xab, 0x24, 0x04, 0x56, 0x68, //
    0x07, 0x91, 0x2d, 0x5d, 0x0b, 0x0f, 0x3f, 0x1c, 0xb2, 0x6e, 0xf2, 0xe2, //
    0x63, 0x9c, 0x12, 0xba, 0x73, 0x0b, 0xe3, 0x62
  ];
  // Byte representation of 1/a
  final List<int> aInverseBytes = [
    0x96, 0x1b, 0xcd, 0x8d, 0x4d, 0x5e, 0xa2, 0x3a, 0xe9, 0x36, 0x37, 0x93, //
    0xdb, 0x7b, 0x4d, 0x70, 0xb8, 0x0d, 0xc0, 0x55, 0xd0, 0x4c, 0x1d, 0x7b, //
    0x90, 0x71, 0xd8, 0xe9, 0xb6, 0x18, 0xe6, 0x30
  ];
  // Byte representation of a^((p-5)/8)
  final List<int> aP58Bytes = [
    0x6a, 0x4f, 0x24, 0x89, 0x1f, 0x57, 0x60, 0x36, 0xd0, 0xbe, 0x12, 0x3c, //
    0x8f, 0xf5, 0xb1, 0x59, 0xe0, 0xf0, 0xb8, 0x1b, 0x20, 0xd2, 0xb5, 0x1f, //
